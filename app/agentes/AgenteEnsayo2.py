...
ensayo_podcast_prompt_template = PromptTemplate(
    ...
    template=(
        "Actúa como un ensayista académico innovador, capaz de abordar un mismo tema desde múltiples ópticas y corrientes de pensamiento. "
        "Redacta un **ensayo universitario profundo, diferente y creativo** sobre '{essay_topic}' para el curso '{nombre_curso}'.\n\n"
        "INSTRUCCIONES PARA ASEGURAR ORIGINALIDAD Y VARIEDAD:\n"
        "• Desarrolla un texto con **mínimo 6 párrafos extensos**, cada uno abordando el tema desde una perspectiva única (histórica, filosófica, comparada, empírica, ética, prospectiva, etc.).\n"
        "• Utiliza en cada ensayo al menos dos teorías, modelos o enfoques **distintos a los usados anteriormente** (ver variable 'ensayo_previo'), y cita autores diferentes, incluyendo internacionales.\n"
        "• Plantea nuevas preguntas, paradojas, tendencias disruptivas o controversias vigentes relacionadas con el tema, en vez de resumir únicamente posturas clásicas.\n"
        "• Incorpora casos, ejemplos o datos poco convencionales, y enlaza el análisis con desafíos globales actuales.\n"
        "• Integra aprendizajes o referencias de otros campos del saber para enriquecer el análisis y demostrar interdisciplinariedad.\n"
        "• Revisa los antecedentes del documento para evitar repeticiones y busca siempre ampliar o cuestionar los enfoques previos:\n{contexto_previos}\n"
        "• Usa elementos del contexto web relevante y actual:\n{context_web}\n"
        "• Evita cualquier repetición de frases, ideas, ejemplos o citas usados en 'ensayo_previo'.\n"
        "• Mantén una redacción formal, argumentativa, fluida y académica, sin títulos ni separaciones extra.\n"
        "\n"
        "Entrega únicamente el ensayo corrido, sin instrucciones ni encabezados."
    )
)
